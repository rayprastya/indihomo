          ...
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card" style='background-image: url("assets/img/more-services-1.jpg");' data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
                ...
                <div class="read-more"><a href="indexx.php?m=produk&s=internet"><i class="icofont-arrow-right"></i> Lihat Lebih Lanjut</a></div>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="card" style='background-image: url("assets/img/tv.jpg");' data-aos="fade-up" data-aos-delay="200">
              <div class="card-body">
                ...
                <div class="read-more"><a href="indexx.php?m=produk&s=tv"><i class="icofont-arrow-right"></i> Lihat Lebih Lanjut</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4">
            <div class="card" style='background-image: url("assets/img/more-services-3.jpg");' data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
                ...
                <div class="read-more"><a href="indexx.php?m=produk&s=telepon"><i class="icofont-arrow-right"></i> Lihat Lebih Lanjut</a></div>
              </div>
            </div>
          </div>
        </div>
