    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            ...
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'keluhan' ? 'active' : '' ?>">
                <a href="index.php?m=keluhan&s=keluhan"><i class="fa fa-chart-pie"></i> <span>Keluhan</span></a>
            </li>
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'ketersediaan' ? 'active' : '' ?>">
                <a href="index.php?m=ketersediaan&s=ketersediaan"><i class="fa fa-chart-pie"></i> <span>Ketersediaan</span></a>
            </li>
            <?php } ?>
