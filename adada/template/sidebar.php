    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            ...
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'produk' ? 'active' : '' ?>">
                <a href="index.php?m=produk&s=produk"><i class="fa fa-file"></i> <span>Produk</span></a>
            </li>
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'user' ? 'active' : '' ?>">
                <a href="index.php?m=user&s=user"><i class="fa fa-users"></i> <span>Add-on</span></a>
            </li>
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'user' ? 'active' : '' ?>">
                <a href="index.php?m=user&s=user"><i class="fa fa-users"></i> <span>Bantuan</span></a>
            </li>
            ...
            <li class="<?= !empty($_GET['m']) && $_GET['m'] == 'undian' ? 'active' : '' ?>">
                <a href="index.php?m=laporan&s=laporan"><i class="fa fa-chart-pie"></i> <span>Undian</span></a>
            </li>
            <?php } ?>
