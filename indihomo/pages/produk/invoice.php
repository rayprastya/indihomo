                    ...
                    <div class="row p-0">
                        <div class="col-md-12">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="border-5 text-uppercase small font-weight-bold">ID</th>
                                        <th class="border-5 text-uppercase small font-weight-bold">Item</th>
                                        <th class="border-5 text-uppercase small font-weight-bold">Description</th>
                                        <th class="border-5 text-uppercase small font-weight-bold">Unit Cost</th>
                                        <th class="border-5 text-uppercase small font-weight-bold">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
